...
// Export individual command factories -- excludes the 65 execve-migrated names (echo, basename,
...
// uname, nproc, uptime, motd) and the 8 true shell builtins now living in
