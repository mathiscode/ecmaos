...
// Export individual command factories -- excludes the 74 execve-migrated names (echo, basename,
...
// uname, nproc, uptime, motd, fmt, crypto, curl, fetch, id, groups, chown, zip, unzip) and the 8 true shell builtins now living in
