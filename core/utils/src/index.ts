...
// Export individual command factories -- excludes the 75 execve-migrated names (echo, basename,
...
// uname, nproc, uptime, motd, fmt, crypto, curl, fetch, id, groups, chown, zip, unzip, git) and the 8 true shell builtins now living in
