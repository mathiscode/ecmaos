...
// Export individual command factories -- excludes the 69 execve-migrated names (echo, basename,
...
// uname, nproc, uptime, motd, fmt, crypto, curl, fetch) and the 8 true shell builtins now living in
