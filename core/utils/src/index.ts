...
// uname, nproc, uptime, motd, fmt, crypto, curl, fetch, id, groups, chown, zip, unzip, git, less, man, and the kernel-native mount, passkey, screensaver-daemon) and the 8 true shell builtins now living in
