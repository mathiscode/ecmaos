...
// Export individual command factories -- excludes the 71 execve-migrated names (echo, basename,
...
// uname, nproc, uptime, motd, fmt, crypto, curl, fetch, id, groups) and the 8 true shell builtins now living in
