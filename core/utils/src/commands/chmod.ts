/**
 * Metadata only -- `chmod`'s real implementation is `core/utils/src/commands-execve/chmod.mjs`,
 ...
 */
export const meta = { command: 'chmod', description: 'Change file mode bits' } as const
