/**
 * Metadata only -- `basename`'s real implementation is `core/utils/src/commands-execve/basename.mjs`,
 ...
 */
export const meta = { command: 'basename', description: 'Strip directory and suffix from filenames' } as const
