/**
 * Metadata only -- `rm`'s real implementation is `core/utils/src/commands-execve/rm.mjs`,
 ...
 */
export const meta = { command: 'rm', description: 'Remove files or directories' } as const
