/**
 * Metadata only -- `touch`'s real implementation is `core/utils/src/commands-execve/touch.mjs`,
 ...
 */
export const meta = { command: 'touch', description: 'Create an empty file' } as const
