/**
 * Metadata only -- `mkdir`'s real implementation is `core/utils/src/commands-execve/mkdir.mjs`,
 ...
 */
export const meta = { command: 'mkdir', description: 'Create a directory' } as const
