/**
 * Metadata only -- `tr`'s real implementation is `core/utils/src/commands-execve/tr.mjs`,
 ...
 */
export const meta = { command: 'tr', description: 'Translate or delete characters' } as const
