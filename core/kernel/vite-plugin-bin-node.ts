 ...
 * legacy dispatch.
 */
export const migratedKernelCommands = ['clear', 'df', 'ps', 'reboot', 'uninstall', 'tty', 'sockets', 'user', 'umount', 'theme', 'crond', 'cron', 'kill', 'killall', 'history', 'format', 'time', 'nc', 'open', 'video', 'play', 'web', 'view', 'vim', 'mount', 'passkey', 'screensaver-daemon', 'app', 'devcli'] as const
